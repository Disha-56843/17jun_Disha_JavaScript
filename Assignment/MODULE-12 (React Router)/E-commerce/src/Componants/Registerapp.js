...
export default function Registerapp() {
  return (
    <div>
        ...
        <div className='mt-3 fs-4 text-center' style={{ color: "#223263" }}> Welcome to E-Com! </div>
        <div className='mt-1 fs-4 text-center' style={{ color: "#848484" }}> Let's make your account </div>

        <form>
          <div className='mx-auto mt-5 input-group w-50 border border-2'>
            <i className='bi bi-person mt-2 ms-2'></i>
            <input type="text" className='ms-1 form-control border border-0' placeholder='Name' />
          </div>
          <div className='mx-auto mt-3 input-group w-50 border border-2'>
            <i className='bi bi-envelope mt-2 ms-2'></i>
            <input type="text" className='ms-1 form-control border border-0' placeholder='Your Email/ Phone Number' />
          </div>
          <div className='mx-auto mt-3 input-group w-50 border border-2 mb-2'>
            <i className='bi bi-lock mt-2 ms-2'></i>
            <input type="text" className='ms-1 form-control border border-0' placeholder='Password' />
          </div>
          <div className='mx-auto mt-3 input-group w-50 border border-2 mb-2'>
            <i className='bi bi-lock mt-2 ms-2'></i>
            <input type="text" className='ms-1 form-control border border-0' placeholder='Confirm Password' />
          </div>
